...
(internal DATABASE_URL)   (tams-backend.up.railway.app)   (tams-txmr.onrender.com)
```
...
- `BACKEND_URL` = `https://tams-backend.up.railway.app` ← API URL, **not** the Postgres URL
- `NEXT_PUBLIC_HOSTED_API_BASE_URL` = `https://tams-backend.up.railway.app/api/v1`
